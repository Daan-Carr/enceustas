    ...
    <div class="container-fluid">
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-12">
                <div class="card bg-dark text-white mb-1">
                    <div class="card-body">
                        <h1 class="card-title">¿A que te dedicas?</h1>
            ...
            <div class="col-sm-12">
                <div class="card bg-dark text-white mb-1">
                    <div class="card-body">
                        <h1 class="card-title">¿Tienes Equipo de Cómputo en Casa?</h1>
            ...
            <div class="col-sm-12">
                <div class="card bg-dark text-white mb-1">
                    <div class="card-body">
                        <h1 class="card-title">¿Tienes Internet En Casa?</h1>
